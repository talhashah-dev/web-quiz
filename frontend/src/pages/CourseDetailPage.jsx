...
const CourseDetailPage = () => {
  ...
  const markAsCompleted = async () => {
    await axios.post(`${import.meta.env.VITE_API_BASE_URL}/api/courses/${id}/complete/${selectedLesson + 1}`, {
      userId,
    });
    alert("✅ علامت‌گذاری شد به عنوان کامل شده");
  };

  if (!course) return <p className="text-center text-white p-6">در حال بارگذاری...</p>;
    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-lg p-6">
        ...
        <div className="border border-gray-700 rounded-lg p-4">
          ...
          <video controls className="w-full rounded my-4" src={lesson.videoUrl} />
